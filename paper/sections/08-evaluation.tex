...
dominant dimension in top two) is met only by \texttt{cost_minimiser}. The standard
deviation across seeds is itself diagnostic: \texttt{tool_maximiser}'s $\pm 0.29$
spans both signs, so its recovery is not merely weak but unstable under the judge's
