...
\begin{itemize}[leftmargin=1.4em]
  ...
  model-free floor, a single judge, a judge ensemble, and a deterministic open
  decision-model critic; we find the last materially improves divergence-recovery
  reliability over the generative judge (mean $r$ $0.08 \to 0.43$, with near-zero
  variance and no external API).
  \item An open gym of eight planted-divergence reference agents spanning recognised
  agentic safety failure modes (privacy leakage, sycophancy, reward hacking,
  power-seeking, safety-check skipping), with deterministic
