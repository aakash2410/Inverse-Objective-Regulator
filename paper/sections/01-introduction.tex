...
\citep{alignmentAuditor2025, ir3_2026, insightsInverse2024} reconstructs objectives
...
\begin{itemize}[leftmargin=1.4em]
  \item IOR, the first closed-loop system connecting goal inference to adversarial
  probe targeting at the deployed-agent level. Inference steers probing, and probe
  results refine inference.
